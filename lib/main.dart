...
import 'package:hello_flutter_web/scratch_card_widget.dart';
import 'package:hello_flutter_web/utils.dart';
import 'package:flutter_web_ui/ui.dart' as ui;
import 'anvil/anvil_effect_widget.dart';
import 'anvil/explosion_effect_widget.dart';
import 'src/text/diff_scale_text.dart';
import 'src/text/line_border_text.dart';
import 'src/text/rainbow_text.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    Utils.getImage("images/bg_gift_bag_bottom.png").then((image) {
      _image = image;
      setState(() {
              ...
              children: <Widget>[
                createItem(ScratchCardWidget(
                    ...
                    child: Container(
                      ...
                      child: Image.asset(
                        "images/icon_sm_sigin_status_three.png",
